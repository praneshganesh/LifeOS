      ...
      >
        ...
        >
          <Animated.View entering={FadeIn.duration(280)} style={styles.header}>
            <Text style={styles.title}>Just did something?</Text>
          ...
          >
            ...
            <View style={styles.metaRow}>
              ...
              >
                ...
                <Text style={styles.metaBtnText}>{formatFriendlyDate(doneOn)}</Text>
              </Pressable>
            ...
            {remindPickerOpen ? (
              <View style={styles.pickerSheet}>
                ...
                {remindKey === 'on' ? (
                  <DateField
                    value={remindOn || toDateInputValue(new Date())}
                    onChange={(v) => {
                      setRemindKey('on');
                      setRemindOn(v);
                    }}
